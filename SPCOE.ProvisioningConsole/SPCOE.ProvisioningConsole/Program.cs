...
namespace SPCOE.ProvisioningConsole
{
    class Program
    {
        /// <summary>
        ...
        static void Main(string[] args)
        {
            ...
            ProvisioningTemplate template = GetProvisioningTemplate(defaultForeground, templateWebUrl, "", null);
        ...
        private static ProvisioningTemplate GetProvisioningTemplate(ConsoleColor defaultForeground, string webUrl, string userName, SecureString pwd)
        {
            using (var ctx = new ClientContext(webUrl))
            {
                ...
                ptci.FileConnector = new FileSystemConnector(Directory.GetCurrentDirectory(), "");
                ...
                XMLTemplateProvider provider = new XMLFileSystemTemplateProvider(Directory.GetCurrentDirectory(), "");
